    ...
    const DEBIT_AND_CREDIT_DATA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDebitAndCreditCalculator.useMemo[DEBIT_AND_CREDIT_DATA]": ()=>{
            ...
            const debit = sorted.map({
                "useDebitAndCreditCalculator.useMemo[DEBIT_AND_CREDIT_DATA].debit": ([, el])=>el.data.expenses
            }["useDebitAndCreditCalculator.useMemo[DEBIT_AND_CREDIT_DATA].debit"]);
            const replenishment = sorted.map({
                "useDebitAndCreditCalculator.useMemo[DEBIT_AND_CREDIT_DATA].replenishment": ([, el])=>el.data.replenishment
            }["useDebitAndCreditCalculator.useMemo[DEBIT_AND_CREDIT_DATA].replenishment"]);
            return {
                isTitle: false,
                isLegend: true,
                isGrid: false,
...
//# sourceMappingURL=src_b1059423._.js.map