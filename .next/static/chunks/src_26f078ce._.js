...
"[project]/src/components/screens/authPage/login.module.scss.module.css [app-client] (css module)": ((__turbopack_context__) => {
...
"[project]/src/components/screens/authPage/useRegisterMutation.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useRegisterMutation = ()=>{
    ...
    const { logIn } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$authContext$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const createRegisterMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Auth"].register,
        onSuccess: {
            "useRegisterMutation.useMutation[createRegisterMutation]": (data)=>{
                logIn(data.jwt, data.user.id);
                router.replace('/');
            }
        }["useRegisterMutation.useMutation[createRegisterMutation]"]
    });
    return {
        createRegisterMutation
    };
};
_s(useRegisterMutation, "Rn6jnK6JGqz/4S/zOJMPJ9UvkKQ=", false, function() {
    return [
...
"[project]/src/components/screens/authPage/useLoginMutation.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useLoginMutation = ()=>{
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { logIn } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$authContext$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const createLoginMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Auth"].login,
        onSuccess: {
            "useLoginMutation.useMutation[createLoginMutation]": (data)=>{
                logIn(data.data.jwt, data.data.user.id);
                router.replace('/');
            }
        }["useLoginMutation.useMutation[createLoginMutation]"]
    });
    return {
        createLoginMutation
    };
};
_s(useLoginMutation, "vYWHZU1rSCIhYuYV54gBARyrvlM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$authContext$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
...
"[project]/src/components/screens/authPage/useAuthLocal.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useRegisterMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screens/authPage/useRegisterMutation.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useLoginMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screens/authPage/useLoginMutation.ts [app-client] (ecmascript)");
...
const useAuthLocal = ()=>{
    ...
    const { createLoginMutation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useLoginMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoginMutation"])();
    const { createRegisterMutation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useRegisterMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRegisterMutation"])();
    ...
    const onSubmit = async (data)=>{
        if (!isLogin) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].promise(createLoginMutation.mutateAsync({
                email: data.email,
                password: data.password
            }), {
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utiles$2f$getToasterPromisSuccess$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToasterPromisSuccess"])('The user is authorized')
            });
        } else {
            if (!data.username) {
                return null;
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].promise(createRegisterMutation.mutateAsync({
                    username: data.username,
                    email: data.email,
                    password: data.password
                }), {
                    ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utiles$2f$getToasterPromisSuccess$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToasterPromisSuccess"])('The user is register')
                });
                reset();
...
_s(useAuthLocal, "V6aisNtOHuewsp3eFb2q0Y47ZoM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useLoginMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoginMutation"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useRegisterMutation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRegisterMutation"],
...
"[project]/src/components/screens/authPage/authPage.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$login$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/screens/authPage/login.module.scss.module.css [app-client] (css module)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useAuthLocal$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screens/authPage/useAuthLocal.ts [app-client] (ecmascript)");
...
const AuthPage = ()=>{
    _s();
    const { onSubmit, isError, isLogin, setIsError, setIsLogin, register, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useAuthLocal$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthLocal"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$login$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].page,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            onSubmit: (e)=>onSubmit(e),
            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$login$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].form,
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$UI$2f$fild$2f$fild$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fild"], {
                    ...
                    ...register('password', {
                        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utiles$2f$getValidateError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getValidateError"])('Password'),
                        minLength: 8
                    })
                }, void 0, false, {
                    fileName: "[project]/src/components/screens/authPage/authPage.tsx",
...
_s(AuthPage, "HHRKYSlj9vidTH1TDlC3EeFOeQU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screens$2f$authPage$2f$useAuthLocal$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthLocal"]
    ];
});
_c = AuthPage;
var _c;
...
//# sourceMappingURL=src_26f078ce._.js.map