    ...
    const WEEKLY_ACTIVITY_DATA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA]": ()=>{
            ...
            transactions?.forEach({
                "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA]": (el)=>{
            ...
            const sorted = [
                ...
                "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].sorted": ([a], [b])=>a.localeCompare(b)
            }["useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].sorted"]);
            const labels = sorted.map({
                "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].labels": ([, el])=>el.day.slice(0, 3)
            }["useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].labels"]);
            const expenses = sorted.map({
                "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].expenses": ([, el])=>el.data.expenses
            }["useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].expenses"]);
            const replenishment = sorted.map({
                "useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].replenishment": ([, el])=>el.data.replenishment
            }["useWeeklyActivityCalculator.useMemo[WEEKLY_ACTIVITY_DATA].replenishment"]);
            return {
                isTitle: false,
                isLegend: true,
                isGrid: true,
...
_s(useWeeklyActivityCalculator, "kHw+cXEuZjEzFO9Qw2LebYGsOGo=", false, function() {
    return [
...
const WeeklyActivity = ()=>{
    _s();
    const { WEEKLY_ACTIVITY_DATA, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$UI$2f$WeeklyActivity$2f$useWeeklyActivityCalculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWeeklyActivityCalculator"])();
...
_s(WeeklyActivity, "CZTDGRN7/6TkSdEq2ih3GtA3d0k=", false, function() {
    return [
...
//# sourceMappingURL=src_e2ee41f2._.js.map